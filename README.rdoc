== Bootstrap-Rails gem
This gem replaces Rails default scaffold and create views and controllers based on Bootstrap, from Twitter (http://twitter.github.com/bootstrap).
...
You can use this gem with only Rails 3. Include this line inside your Gemfile:
  gem 'bootstrap-rails', :path => '/path/to/gemfolder'
...
This gem uses jquery-toastmessage plugin and bootstrap dropdown menu. Include these lines in app/assets/javascripts/application.js file
  //= require bootstrap-dropdown
  //= require jquery.toastmessage

=== Loading required CSS files
Include these lines in app/assets/stylesheets/application.css file
   *= require bootstrap
   *= require jquery.toastmessage
